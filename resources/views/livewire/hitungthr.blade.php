<div>
    @section('title', 'Laporan Hitung THR')

    <div class="card shadow-sm border-0">
        <div class="card-header bg-white py-3">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="mb-0 fw-bold text-dark">Data THR Karyawan Non-OS</h4>
                    <small class="text-muted">Periode sampai: <strong>{{ format_tgl($cutOffDate) }}</strong></small>
                </div>
