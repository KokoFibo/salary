                    ...
                    @if (!$is_add && !$is_update)
                        ...
                        @if (count($data) > 0)
                            @foreach ($data as $key => $d)
                                <div
                                    class="{{ $d->status == 'Done' ? 'bg-green-700' : 'bg-blue-600' }}  text-white m-3 p-3 rounded-xl">
                                        ...
                                        @else
                                            ...
                                            <ul>
                                                <div>
                                                    ...
                                                    <li>{{ $d->description }}</li>
                                                    @if ($d->status == 'Done')
                                                        <li>{{ $d->status }} {{ format_tgl($d->done_date) }}
                                                        </li>
                                                    @else
                                                ...
                                                <div class="lg:my-5 py-2 w-full lg:w-1/2 ">
                                                    <div class="d-flex justify-content-between px-1 pb-2">
                                                        <div>
                                                            <div>
                                                                <button
                                                                    class="bg-red-500 py-0 px-3 text-white rounded text-sm"
                                                    ...
                                                    @if (strtolower(getFilenameExtension($fn->originalName)) != 'pdf')
                                                        <img class="w-full rounded-xl"
                                                            src="{{ getUrl($fn->filename) }}" alt="">
                                                    @else
                                                        <iframe class="w-full rounded-xl"
                                                            src="{{ getUrl($fn->filename) }}" width="100%"
                                                            height="600px"></iframe>
                                                    @endif
                                                </div>
                                            @endforeach
                            ...
                            <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                                <div class="mb-4">
                                    <label for="requester_name" class="block text-gray-700 text-sm font-bold mb-2">Nama
                                        Pemohon</label>
                                    <input id="requester_name" name="requester_name" type="text" wire:model='name'
                                        disabled
                                ...
                                <div class="mb-4">
                                    <label for="file_upload" class="block text-gray-700 text-sm font-bold mb-2">Upload
                                        Surat
                                        Keterangan</label>
