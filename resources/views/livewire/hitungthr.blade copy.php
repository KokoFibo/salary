<div>
    ...
    <div class="card p-3">
        <div class="card-header">
            ...
            <p>
            <p>
            <p>Lama Bekerja >= 12 bulan -> 1 bulan gaji</p>
            <p>Lama Bekerja
            <p 12 bulan -> Prorate ( Lama Bekerja / 12 bulan * Gaji)</p>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ number_format(selisihBulan($k->tanggal_bergabung, $cutOffDate), 1) }}</td>
